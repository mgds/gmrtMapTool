...
<html>
<head>
	<title>Marine Geoscience Data System: GMRT MapTool South Polar</title>
	...
	<script src="/tools/GMRTMapTool/sp/js/ol-debug.js" type="text/javascript"></script>
    <script src="/tools/GMRTMapTool/sp/js/basemap_v3.js?a=1" type="text/javascript"></script>
    ...
    <div id="contentboxes" style="display:none">
        ...
        <div id="gridboundsdiv">
            ...
            <div class="boundscontainer">
                <div class="title">GMRT MapTool</div>
                <div class="instructions">Select a region directly from the map, or modify fields below. Units are in EPSG:3031.</div>
