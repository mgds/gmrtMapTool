...
MGDSMapClient.prototype.mapInit = function(hide,options,off) {
    ...
    projection.setWorldExtent([-180.0000, 60.0000, 180.0000, 90.0000]);
...
MGDSMapClient.prototype.createLayerSwitcher = function() {
    ...
    $(this.mapControl.getImgButton('north_polar')).addClass('on').removeClass('toggle');
...
MGDSMapClient.prototype.addLayers = function() {
	...
	source: new ol.source.TileWMS({
	    ...
	    "http://gmrt.marine-geo.org/cgi-bin/mapserv?map=/public/mgg/web/gmrt.marine-geo.org/htdocs/services/map/wms_np.map",
	...
	source: new ol.source.TileWMS({
	    ...
	    "http://gmrt.marine-geo.org/cgi-bin/mapserv?map=/public/mgg/web/gmrt.marine-geo.org/htdocs/services/map/wms_np_mask.map",
